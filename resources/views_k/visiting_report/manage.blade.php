                    ...
                    <div class="box-body">
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-sm-4"> 
									<select name="report_type" id="report_type" class="select2" style="width:100%">
										...
										<option value="office_wise">Office Wise</option>
										<option value="state_wise">State Wise</option>
										<option value="visit_attend">Visit Attend</option>
							...
							<div class="form-group col-md-12">
								...
								<div class="col-sm-4"> 
									<input type="text" placeholder="Select From Date" name="from_date" id="from_date" class="form-control datepicker" > 
								</div>
							</div>
							<div class="form-group col-md-12">
								<div class="col-sm-2 col-md-offset-3">
								...
								<div class="col-sm-4"> 
									<input type="text" placeholder="Select To Date" name="to_date" id="to_date" class="form-control datepicker" >
								</div>
							</div>
