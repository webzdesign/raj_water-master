       ...
       <div class="box">
		...
		<table class="no_border" width="100%" style="margin-left: 2%; ">
			<tr>
				...
				<td colspan="3" style="padding-right: 2%; "  align="right" class="no_border">Date :- {{ date('jS F Y',strtotime($result[0]->quatation_date)) }}

			</tr>
			<tr>
				<td colspan="3" style="padding-right: 2%; "   align="right" class="no_border">{{ date('l',strtotime($result[0]->quatation_date))}}
			</tr>
			<tr>
			...
			<tr>
				...
				<?php
				$result[0]->address;
				if($result[0]->country_name != '')
				{
					echo '<br />';
					echo "<b>Country : </b>".$result[0]->country_name."<br/>";
					echo "<b>Country : </b>".$result[0]->state_name."<br/>";
					echo "<b>Country : </b>".$result[0]->city_name."<br/>";
				}
				...
				<tr>
					...
					<td align="center"><?php
						 ...
						 <?php
							...
							{
						?>
							<img src="{{ URL::asset('external/quatation_formate/rupee.png') }}"/>
						<?php
							}
							else
							{
						?>
							<img src="{{ URL::asset('external/quatation_formate/doller.png') }}"/>
						<?php
							}
						?>
						 <?php echo $tot;
