									...
									for($i=0; $i<count($p_id_arr);$i++)
									{
										...
										<tr>
											...
											<td>
												<div class="input-group">
													<input readonly value="<?php echo number_format((float)array_sum($amount_arr),2,'.',''); ?>" type="text" id="total" name="total" class="form-control amountonly">
												</div>
											</td>
											<td></td>
										</tr>
										...
										<tr>
											...
											<div class="input-group">
												...
												<input type="text" id="total_amount" name="total_amount" value="<?php echo number_format((float)array_sum($amount_arr),2,'.',''); ?>" readonly class="form-control">
											</div>
											</td>
											<td></td>
										</tr>
