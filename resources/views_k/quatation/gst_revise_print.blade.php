...
<body>
		...
		<div id="watermark">
			...
			<img style="height:200px;" class="letter_head_img" src="{{ URL::asset('external/quatation_formate/'.$letter_head[0]->letterhead_name) }}" width="100%" />
	...
	<div class="dataTables_wrapper">
		...
		<table class="no_border" width="100%">
			<tr>
				<td colspan="3" align="right" class="no_border">Date :- {{ date('jS F Y',strtotime($result[0]->revise_date)) }}
			</tr>
			<tr>
				<td colspan="3" align="right" class="no_border">{{ date('l',strtotime($result[0]->revise_date))}}
			</tr>
			<tr>
				<td class="no_border" width="19%">Quotation No</td>
				<td class="no_border" align="right" width="1%">:-</td>
				<td class="no_border" width="80%">{{ $result[0]->revise_quatation_no }}</td>
			</tr>
			<tr>
				<td class="no_border">Concern Person</td>
				<td class="no_border" align="right">:-</td>
				<td class="no_border">{{ $result[0]->prefix.' '.$result[0]->customer_name }}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="no_border" align="right">:-</td>
				<td class="no_border">{{ $result[0]->company }}</td>
			</tr>
			<tr>
				<td class="no_border">Address</td>
				<td class="no_border" align="right">:-</td>
				<td class="no_border"><?=$result[0]->address?></td>
			</tr>

		</table>

		<p>
			<center><h2><u>Quotation For {{ $result[0]->product_name}}</u></h2></center>
		</p>
		...
		<div class="page-break"></div>
			...
			?>
				...
				<tr>
					...
					<td align="center"><b><?php
						 $gst_total =($result[0]->total_amount*18) / 100;
						 $gst_tot = moneyFormatIndia( $gst_total); ?>
				...
				<tr>
					<td colspan="3" ><b>Total Amount in Words :- </b><br />
						<?php
						$grand_tot = $gst_total + $result[0]->total_amount;
							echo  decimal_to_words(number_format((float)$grand_tot,2,'.',''));
						?>
					</td>
					<td  align="right"><b>Total Amount</b></td>
					<td align="center"><b><?php

						 $grand_total = moneyFormatIndia($grand_tot); ?>
