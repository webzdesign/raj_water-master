                    ...
                    <div class="box-body">
						<div class="row">
							...
							<div class="form-group col-md-12">
								...
								<div class="col-sm-4">
									<input type="text" name="from_date" id="from_date" placeholder="Inquiry From Date" class="form-control pull-right datepicker" >
								</div>
							</div>
							<div class="form-group col-md-12">
								<div class="col-sm-2 col-md-offset-3">
								...
								<div class="col-sm-4">
									<input type="text" placeholder="Inquiry To Date" name="to_date" id="to_date" class="form-control pull-right datepicker" >
								</div>
							</div>
