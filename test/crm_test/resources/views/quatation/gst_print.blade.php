...
<body>
	...
	<img style="height:200px;" src="{{ URL::asset('external/quatation_formate/'.$letter_head[0]->letterhead_name) }}" width="100%" />
	...
	<div class="dataTables_wrapper">
		...
		<table class="no_border" width="100%">
			<tr>
				<td colspan="3" align="right" class="no_border">Date :- {{ date('jS F Y',strtotime($result[0]->quatation_date)) }}
			</tr>
			<tr>
				<td colspan="3" align="right" class="no_border">{{ date('l',strtotime($result[0]->quatation_date))}}
			</tr>
			<tr>
				<td class="no_border" width="19%">Quotation No</td>
				<td class="no_border" align="right" width="1%">:-</td>
				<td class="no_border" width="80%">{{ $result[0]->quatation_no }}</td>
			</tr>
			<tr>
