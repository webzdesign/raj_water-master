            	...
            	<div class="tab-content">
						...
						{{ csrf_field() }}
                     	 <div class="box box-primary">
                            <div class="box-body">
								...
								<input type="hidden" id="follow_up_btn_val" name="follow_up_btn_val" >
								...
								@if($role_id == 1)
									<div class="form-group col-sm-12 col-md-offset-4">
										<div class="col-sm-2">
											<center>
												<input type="submit" id="approve_click" name="approve" class="btn btn-primary mybtn all_btn_hide" value="Approve" />
											</center>
										</div>
										<div class="col-sm-2">
											<center><input type="submit" id="refuse_click" name="refuse" class="btn btn-primary mybtn" value="Refuse" ></center>
										</div>
									</div>
									{!! Form::close() !!}
								@else
					...
					<div class="tab-pane" id="document_detail">
					 ...
					 <div class="tab-pane " id="visiting_detail">
						{!! Form::open(array( 'method' => 'post' , 'files' => true ,'id'=>"visiting_form",'name'=>"visiting_form",'class'=>"visiting_form"))!!}
							{!! Form::hidden('inquiry_id',$result[0]->inquiry_id, array('id'=>"inquiry_id")) !!}
							{!! Form::hidden('quatation_id',$result[0]->quatation_id, array('id'=>"quatation_id")) !!}
							{!! Form::hidden('last_follow_id',$follow_ups[0]->follow_up_id, array('id'=>"last_follow_id")) !!}
							{{ csrf_field() }}
...
jQuery(document).ready(function($){
	...
	$('body').on('click','#approve_click',function(){
		$('#follow_up_btn_val').val('approve');
	});
	$('body').on('click','#refuse_click',function(){
		$('#follow_up_btn_val').val('refuse');
	});
