...

{
...

	{
		...
		Mail::send('email_test.welcome', $data, function ($message) {



			$message->from('hardikponkiya.ap@gmail.com', 'Learning Laravel');



			$message->to('snehadoshi.ap@gmail.com')->subject('Learning Laravel email');
