...
Route::get('Inquiry/get_inq','Inquiry@get_inq');
Route::get('Inquiry/get_active_inq','Inquiry@get_active_inq');
Route::get('Inquiry/get_cancel_inq','Inquiry@get_cancel_inq');
Route::get('Inquiry/get_delete_inq','Inquiry@get_delete_inq');
...
Route::get('Quatation/get_inq_pending','Quatation@get_inq_pending');
Route::get('Quatation/get_inq_quotation','Quatation@get_inq_quotation');
Route::get('Quatation/get_inq_revise','Quatation@get_inq_revise');
Route::get('Quatation/get_inq_cancel','Quatation@get_inq_cancel');
...
Route::get('Proforma_Invoice/generate_invoice/{id}','Proforma_Invoice@generate_invoice');
